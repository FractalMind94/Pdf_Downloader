# -*- coding: utf-8 -*-
"""
Created on Fri Apr 19 13:30:50 2024
    ...
    if not os.path.isfile(f"C:/Users/KOM/Desktop/Opgaver/Uge11/PDF/{BRnum}.pdf"):
        try:
            ...
            if 200 <= response.status_code < 300:
                ...
                print(f"PDF file {BRnum} downloaded successfully.")
            ...
            # If Pdf_URL download fails, try downloading from Report Html Address
                ...
                if 200 <= response.status_code < 300:
                    ...
                    with open(f"{BRnum}.pdf", "wb") as writer:
                        writer.write(response.content)
                    print(
                        f"PDF file {BRnum} downloaded successfully from Report Html Address."
                    )
                    meta.loc[meta["BRnum"] == BRnum, "pdf_downloaded"] = "Downloaded"

                else:
                    print(
                        f"Failed to download PDF file {BRnum}. Status code:",
                        response.status_code,
                    )
                    meta.loc[meta["BRnum"] == BRnum, "pdf_downloaded"] = (
                        "Not Downloaded"
                    )
...
meta.to_excel(
    "C:/Users/KOM/Desktop/Opgaver/Uge11/Metadata2006_2016_new.xlsx", index=False
)
